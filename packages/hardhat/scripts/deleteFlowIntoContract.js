...
//3) run: npx hardhat run scripts/deleteFlowIntoContract.js --network MUMBAI
async function main() {
    ...
    await sobrFlow
        ...
        .then(function (tx) {
            console.log(`
        Congrats! You just successfully delete a flow that was being sent into the SOBR flow contract.
        Tx Hash: ${tx.hash}
    `)
        })
}
